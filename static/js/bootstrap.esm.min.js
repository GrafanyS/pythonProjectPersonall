...
function addHandler(e, t, n, i, s) {
    ...
    const l = getElementEvents(e), c = l[a] || (l[a] = {}), _ = findHandler(c, r, o ? n : null);
...
const EventHandler = {
    on(e, t, n, i) {
        ...
        if ("string" != typeof t || !e) return;
        const [s, o, r] = normalizeParameters(t, n, i), a = r !== t, l = getElementEvents(e), c = l[r] || {},
            _ = t.startsWith(".");
        if (void 0 === o) {
...
const NAME$7 = "modal", DATA_KEY$4 = "bs.modal", EVENT_KEY$4 = ".bs.modal", DATA_API_KEY$2 = ".data-api",
    ...
    EVENT_RESIZE$1 = "resize.bs.modal", EVENT_MOUSEDOWN_DISMISS = "mousedown.dismiss.bs.modal",
...
class Tab extends BaseComponent {
    ...
    _activate(e, t) {
        e && (e.classList.add("active"), this._activate(getElementFromSelector(e)), this._queueCallback((() => {
            "tab" === e.getAttribute("role") ? (e.focus(), e.removeAttribute("tabindex"), e.setAttribute("aria-selected", !0), this._toggleDropDown(e, !0), EventHandler.trigger(e, EVENT_SHOWN$1, {relatedTarget: t})) : e.classList.add("show")
